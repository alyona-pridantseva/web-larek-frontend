...
Расширяется базовым абстрактным классом `Model` по интерфейсу `IAppData`.
...
Ответственен за представление данных продукта в проекте. Расширяется базовым абстрактным классом `Model` по интерфейсу `IProductItem`.
...
Ответственен за формирование страницы. Расширяется базовым абстрактным классом `Component` по интерфейсу `IPage`.
...
Ответственен за отображение на странице информации о продукте. Расширяется базовым абстрактным классом `Component`.
...
Управляет отображением модального окна. Расширяется базовым абстрактным классом `Component` по интерфейсу `IModalData`.
...
Управляет формами, отвечает за её отображение и валидацию. Расширяется базовым абстрактным классом `Component`.
...
Ответственен за отображение содержимого корзины и предоставляет методы для управления содержимым. Расширяется базовым абстрактным классом `Component` по интерфейсу `IBasketView`.
...
Ответственен за реализацию отображения продуктов, которые добавлены в корзину, а также предоставляет методы, чтобы  ими управлять. Расширяется базовым абстрактным классом `Component` по интерфейсу `IBasketProduct`.
...
Форма доставки. Позволяет хранить и изменять данные при оформлении заказа. Расширяется базовым классом `Form` по интерфейсу `IAddressForm`.
...
Форма контактных данных. Позволяет хранить и изменять данные при оформлении заказа. Расширяется базовым классом `Form` по интерфейсу `IContactsForm`.
...
Успешное оформление заказа. Расширяется базовым абстрактным классом `Component` по интерфейсу `ISuccessOrder`
